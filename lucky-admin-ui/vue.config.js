...
const name = defaultSettings.title || 'Lucky Admin Vue' // page title
...
// 所有配置项的解释可以在https://cli.vuejs.org/config/中找到
module.exports = {
  /**
  ...
  */
  ...
  devServer: {
    ...
    // 代理配置可以在这里找到文档: https://cli.vuejs.org/config/#devserver-proxy
    proxy:{
