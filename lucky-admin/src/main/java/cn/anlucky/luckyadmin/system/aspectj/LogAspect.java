package cn.anlucky.luckyadmin.system.aspectj;

import cn.anlucky.luckyadmin.system.annotation.Log;
import cn.anlucky.luckyadmin.system.enums.BusinessStatus;
import cn.anlucky.luckyadmin.system.enums.HttpMethod;
import cn.anlucky.luckyadmin.system.filter.PropertyPreExcludeFilter;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        ...
        {
            // 获取当前的用户
            Long loginId = SaUtils.getLoginIdAsLong();
            String username = SaUtils.getLoginUserName();
